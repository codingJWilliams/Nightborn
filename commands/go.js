...
class GoCommand extends Command {
  constructor() {
    super('go', {
      ...
      userPermissions: (message => {
        return message.author.id === "169979133470703617" || (bpf(["owner", "techies", "dons", "mods", "intern", "event_orgs"]))(message)
      }),
      args: [{
        id: "ch",
        type: "voiceChannel"
  ...
  async exec(message, args) {
    ...
    if (args.ch.id == "362911608864768000") {
      message.channel.send("That's the staff vc D:");
      return;
    }
