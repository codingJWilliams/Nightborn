    ...
    exec() {
        ...
        this.client.on("message", async(message) => {
            ...
            if (staffQuotes.filter(s => {
                ...
                await message.channel.send(sObj.quotes[Math.floor(sObj.quotes.length * Math.random())] + " - " + sMember.displayName  + " ```We have just 3 weeks to save net neutrality. Act now.``` <https://www.battleforthenet.com/>");
